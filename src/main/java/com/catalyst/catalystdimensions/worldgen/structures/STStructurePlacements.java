...
import com.catalyst.catalystdimensions.worldgen.structures.structureplacement.DistanceBasedStructurePlacement;
...
public class STStructurePlacements {
     ...
     */
    public static final DeferredRegister<StructurePlacementType<?>> DEFERRED_REGISTRY_STRUCTURE_PLACEMENT_TYPE = DeferredRegister.create(Registries.STRUCTURE_PLACEMENT, CatalystDimensions.MODID);
