...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_CRYSTAL = registerKey("add_mana_crystal_purple");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_CRYSTAL, new BiomeModifiers.AddFeaturesBiomeModifier(
