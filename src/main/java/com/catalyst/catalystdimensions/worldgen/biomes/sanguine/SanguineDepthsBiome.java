package com.catalyst.catalystdimensions.worldgen.biomes.sanguine;
...
public class SanguineDepthsBiome {
    ...
    public static Biome sanguineDepths(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        // Mob spawns
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        ...
                        .fogColor(0xD94F4F)
                        .grassColorOverride(0xbb0202)
                        .foliageColorOverride(0xbb0202)
